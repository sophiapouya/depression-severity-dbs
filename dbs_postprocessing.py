from src.postprocessing_functions import *
...
for sbj in all_subjs:
    for ref_type in ref_types:
        ...
        save_power_data_from_fif(band_coefficients=band_coefficients, FEATURE_BANDS=FEATURE_BANDS, EXCLUDED_SESSIONS=EXCLUDED_SESSIONS, ref_type=ref_type, subj_name=sbj, sbj_dir=sbj_dir)
