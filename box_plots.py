...
input_folder = Path("/Users/sophiapouya/workspace/bcm/CATDI/neuralData/dbsData/pca/box_plot_data")
output_dir = "/Users/sophiapouya/workspace/bcm/CATDI/neuralData/dbsData/pca/box_plot_data"

pca_list = []
for file in input_folder.glob("*.csv"):
    # files named like -> pca_OLS_KFOLD_LEFT_probes.csv
    name_parts = file.stem.split("_")
    regression_method= name_parts[1]
    cv_method = name_parts[2]
    probe = name_parts[3]
