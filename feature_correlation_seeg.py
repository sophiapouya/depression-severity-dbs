...
features_csv_path = '/Users/sophiapouya/workspace/bcm/CATDI/neuralData/seegData/CATDI_master_features.csv'
feature_pd = pd.read_csv(features_csv_path)

# output directory
save_dir = "/Users/sophiapouya/workspace/bcm/CATDI/depression-severity-dbs/feature_corr_plots_seeg"
